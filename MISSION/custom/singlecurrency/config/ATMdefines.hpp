class ATM_RscScrollBar
{
	...
	thumb = "custom\singlecurrency\gui\menu\thumb_ca.paa";
	arrowEmpty = "custom\singlecurrency\gui\varrowEmpty_ca.paa";
	arrowFull = "custom\singlecurrency\gui\menu\arrowFull_ca.paa";
	border = "custom\singlecurrency\gui\menu\border_ca.paa";
	shadow = 0;
	scrollSpeed = 0.06;
	width = 0;
	height = 0;
...
class ATM_RscTree {
	...
	expandedTexture = "custom\singlecurrency\gui\menu\expandedTexture_ca.paa";
	hiddenTexture = "custom\singlecurrency\gui\menu\hiddenTexture_ca.paa";
	rowHeight = 0.0439091;
	color[] = {1, 1, 1, 1};
...
class ATM_RscShortcutButton {
	...
	animTextureDefault = "custom\singlecurrency\gui\menu\normal_ca.paa";
	animTextureNormal = "custom\singlecurrency\gui\menu\normal_ca.paa";
	animTextureDisabled = "custom\singlecurrency\gui\menu\normal_ca.paa";
	animTextureOver = "custom\singlecurrency\gui\menu\over_ca.paa";
	animTextureFocused = "custom\singlecurrency\gui\menu\focus_ca.paa";
	animTexturePressed = "custom\singlecurrency\gui\menu\down_ca.paa";
	periodFocus = 1.2;
	periodOver = 0.8;
	class HitZone
	{
...
class ATM_RscShortcutButtonMain : ATM_RscShortcutButton {
	...
	animTextureNormal = "custom\singlecurrency\gui\main\normal_ca.paa";
	animTextureDisabled = "custom\singlecurrency\gui\main\disabled_ca.paa";
	animTextureOver = "custom\singlecurrency\gui\main\over_ca.paa";
	animTextureFocused = "custom\singlecurrency\gui\main\focus_ca.paa";
	animTexturePressed = "custom\singlecurrency\gui\main\down_ca.paa";
	animTextureDefault = "custom\singlecurrency\gui\main\normal_ca.paa";
	period = 0.5;
	font = "Zeppelin32";
...
class ATM_RscListBox 
{
	...
	arrowFull = "custom\singlecurrency\gui\menu\arrowFull_ca.paa";
	arrowEmpty = "custom\singlecurrency\gui\menu\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	rowHeight = 0.04;
	color[] = {0.7, 0.7, 0.7, 1};
	colorActive[] = {0,0,0,1};
...
class ATM_RscXSliderH 
{
	...
	arrowEmpty = "custom\singlecurrency\gui\slider\arrowEmpty_ca.paa";
	arrowFull = "custom\singlecurrency\gui\slider\arrowFull_ca.paa";
	border = "custom\singlecurrency\gui\slider\border_ca.paa";
	thumb = "custom\singlecurrency\gui\slider\thumb_ca.paa";
};
...
class ATM_RscHTML {
	...
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	prevPage = "custom\singlecurrency\gui\menu\arrow_left_ca.paa";
	nextPage = "custom\singlecurrency\gui\menu\arrow_right_ca.paa";
	shadow = 2;
	class H1 {
		font = "Zeppelin32";
		fontBold = "Zeppelin32";
...
class ATM_RscCombo {
	...
	arrowFull = "custom\singlecurrency\gui\menu\arrowFull_sca.paa";
	arrowEmpty = "custom\singlecurrency\gui\menu\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	color[] = {1, 1, 1, 1};
	colorActive[] = {1, 0, 0, 1};
