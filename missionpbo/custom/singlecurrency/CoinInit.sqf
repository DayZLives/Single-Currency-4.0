...
call compile preprocessFileLineNumbers "custom\singlecurrency\compile\player_traderMenu.sqf";

BIS_fnc_numberDigits = compile preprocessFileLineNumbers "custom\singlecurrency\numberDigits.sqf";
BIS_fnc_numberText = compile preprocessFileLineNumbers "custom\singlecurrency\numberText.sqf"; 
SC_fnc_removeCoins = compile preprocessFileLineNumbers "custom\singlecurrency\compile\SC_fnc_removeCoins.sqf";
SC_fnc_addCoins = compile preprocessFileLineNumbers "custom\singlecurrency\compile\SC_fnc_addCoins.sqf";
